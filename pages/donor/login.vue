  ...
  <NuxtLayout name="donor-layout">
    ...
    <div class="flex">
      ...
      <form
        ...
        class="w-full sm:w-2/4 flex flex-col items-center justify-center gap-4"
      >
        <h3 class="text-red-500 text-center text-2xl">Donor Login</h3>
...
const loginUser = async () => {
  loading.value = true;
  await login({ email: email.value, password: password.value }, "donor");
  loading.value = false;
